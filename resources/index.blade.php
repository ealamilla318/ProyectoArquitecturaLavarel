...
<head>
    ...
    <link rel="stylesheet" href="{{route(css/owl.carousel.min.css)}}">
    <link rel="stylesheet" href="{{route(css/magnific-popup.css)}}">
    <link rel="stylesheet" href="{{route(css/font-awesome.min.css)}}">
    <link rel="stylesheet" href="{{route(css/themify-icons.css)}}">
    <link rel="stylesheet" href="{{route(css/nice-select.css)}}">
    <link rel="stylesheet" href="{{route(css/flaticon.css)}}">
    <link rel="stylesheet" href="{{route(css/animate.css)}}">
    <link rel="stylesheet" href="{{route(css/slicknav.css)}}">
