    ...
    <div class="features-boxed">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Bienvenido Administrador : {{ Auth::user()->name }}</p>
            </div>
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-map-marker icon"></i>
                        <h3 class="name"><a href="{{ url('/TablaH') }}">Inventario Herramientas</a></h3>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-clock-o icon"></i>
                        <h3 class="name"><a href="{{ url('/TablaQ') }}">Inventario Quimicos</a></h3>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
